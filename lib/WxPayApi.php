...
namespace lib\WxPayApi;

use lib\WxPayBizPayUrl\WxPayBizPayUrl;
use lib\WxPayCloseOrder\WxPayCloseOrder;
use lib\WxPayDownloadBill\WxPayDownloadBill;
use lib\WxPayMicroPay\WxPayMicroPay;
use lib\WxPayOrderQuery\WxPayOrderQuery;
use lib\WxPayRefund\WxPayRefund;
use lib\WxPayRefundQuery\WxPayRefundQuery;
use lib\WxPayReport\WxPayReport;
use lib\WxPayResults\WxPayResults;
use lib\WxPayReverse\WxPayReverse;
use lib\WxPayShortUrl\WxPayShortUrl;
use lib\WxPayUnifiedOrder\WxPayUnifiedOrder;
use lib\WxPayException\WxPayException;
